...
@Component({
  ...
  standalone: true,
  template: `
    <svg fill="none" viewBox="0 0 242 256" class="w-full h-full">
      <g clip-path="url(#angular__a)">
        <mask id="angular__b" width="242" height="256" x="0" y="0" maskUnits="userSpaceOnUse" style="mask-type:luminance">
